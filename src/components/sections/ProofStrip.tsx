    ...
    <Section id="proof" className="py-10">
      <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
        <div className="text-center">
          <p className="font-display text-3xl text-[var(--tone-fg)]">
        ...
        <div className="col-span-2 text-center md:col-span-1">
          <p className="font-display text-3xl text-[var(--tone-fg)]">5.0</p>
        ...
        <div className="col-span-2 text-center md:col-span-2">
          <p className="font-display text-lg text-[var(--tone-fg)]">NV Mag</p>
